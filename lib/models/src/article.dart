...
class Articles {
  ...
  static _getArticleList(Map<String, dynamic> json) {
    ...
    json['edges'].forEach((article) => articleList.add(Article.fromJson(article)) );
    return articleList;
  }
}
...
class Article {
  ...
  static Article fromJson(Map<String, dynamic> json){
    return Article(
      author: AuthorV2.fromJson((json['node'] ?? const {})['authorV2']),
      commentList: _getCommentList((json['node'] ?? const {})['comments']),
  ...
  static _getCommentList(Map<String, dynamic> json){
    ...
    json['edges'].forEach((comment) => commentList.add(Comment.fromJson(comment)));
    return commentList;
  }
