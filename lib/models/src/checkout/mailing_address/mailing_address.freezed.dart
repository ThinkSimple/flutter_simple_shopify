...
class _$_MailingAddress implements _MailingAddress {
  ...
  factory _$_MailingAddress.fromJson(Map<String, dynamic> json) =>
      _$_$_MailingAddressFromJson(json);
  ...
  @override
  String toString() {
    return 'MailingAddress(address1: $address1, address2: $address2, city: $city, company: $company, country: $country, countryCodeV2: $countryCodeV2, firstName: $firstName, formattedArea: $formattedArea, id: $id, lastName: $lastName, latitude: $latitude, longitude: $longitude, name: $name, phone: $phone, province: $province, provinceCode: $provinceCode, zip: $zip)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$_$_MailingAddressToJson(this);
  }
}
