...
class _$_ShippingAddress implements _ShippingAddress {
  ...
  factory _$_ShippingAddress.fromJson(Map<String, dynamic> json) =>
      _$_$_ShippingAddressFromJson(json);
  ...
  @override
  String toString() {
    return 'ShippingAddress(address1: $address1, address2: $address2, city: $city, company: $company, country: $country, countryCodeV2: $countryCodeV2, firstName: $firstName, id: $id, lastName: $lastName, latitude: $latitude, longitude: $longitude, name: $name, phone: $phone, province: $province, provinceCode: $provinceCode, zip: $zip)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$_$_ShippingAddressToJson(this);
  }
}
