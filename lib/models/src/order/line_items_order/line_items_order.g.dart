...
_$_LineItemsOrder _$_$_LineItemsOrderFromJson(Map<String, dynamic> json) {
  return _$_LineItemsOrder(
...
Map<String, dynamic> _$_$_LineItemsOrderToJson(_$_LineItemsOrder instance) =>
    <String, dynamic>{
